...
export const VariableProvider = ({ children }) => {
    ...
    const [currentDetectiveIdentification, setCurrentDetectiveIdentification] = useState(null);
    const [currentAngelProtection, setCurrentAngelProtection] = useState(null);
    const [currentCivilianTriviaFinishes, setCurrentCivilianTriviaFinishes] = useState([]);
