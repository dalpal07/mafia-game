const questions = [
  ...
  {
    question:
      "during the mid-20th century, the Mafia played a significant role in the development of which American city?",
    options: ["New York", "Chicago", "Los Angeles", "Las Vegas"],
    answer: "Las Vegas",
  },
  {
    question:
      "what term is commonly used to describe the Mafia's code of silence and refusal to cooperate with law enforcement?",
    options: ["Omerta", "Cosa Nostra", "Capo", "Consigliere"],
    answer: "Omerta",
  },
  {
    question:
      "what former Mafia member became a high-profile informant, helping the FBI dismantle the American Mafia in the 1980s?",
    options: [
      "John Junior Gotti",
  ...
  {
    question:
      "what city is often considered the birthplace of the real-life Mafia, where criminal organizations like the Sicilian Mafia first emerged?",
    options: ["Rome", "Naples", "Palermo", "Venice"],
    answer: "Palermo",
  },
  {
    question:
      "what is the name of the Italian-American Mafia that emerged in the United States during the late 19th century?",
